...
parser.add_argument('--csv_file_val', type=str, default="./source_code_of_skin/data/skin/testing.csv", help='validation set csv file')
parser.add_argument('--csv_file_test', type=str, default="./source_code_of_skin/data/skin/validation.csv", help='testing set csv file')
